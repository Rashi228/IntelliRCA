...
def create_rca_workflow():
    ...
    workflow.add_node("business_impact_analyzer", business_impact_agent)
    ...
    workflow.add_edge("memory_analyzer", "business_impact_analyzer")
    workflow.add_edge("business_impact_analyzer", "rca_generator")
